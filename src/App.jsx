...
import TemperatureChart from './store/components/TemperatureChart';

function App() {
  const { currentTemp, systemStatus, setTemperature, upperThreshold, lowerThreshold } = useStore();

  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center py-12 px-4 gap-8 font-sans">
      ...
      <div className="flex flex-col lg:flex-row gap-8 w-full max-w-5xl">
        ...
        <div className="bg-slate-900 p-8 rounded-2xl border border-slate-800 shadow-2xl text-center w-full lg:w-1/3 flex flex-col justify-center">
